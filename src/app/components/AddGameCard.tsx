...
export default function AddGameCard() {
  return (
    <Card className="group flex flex-col items-center justify-center border-2 border-dashed border-border bg-transparent aspect-[191/281] w-full hover:border-primary hover:bg-card/50 transition-all duration-200 cursor-pointer shadow-none">
